...
var offline = exports.offline = function offline() {
  ...
  return function (createStore) {
    return function (reducer, preloadedState) {
      ...
      // create store
      var initialStore = offlineEnhancer(createStore)(offlineReducer, preloadedState, enhancer);

      var baseReplaceReducer = initialStore.replaceReducer.bind(initialStore);
